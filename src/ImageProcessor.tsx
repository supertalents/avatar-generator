    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post<APIResponse>(
                ...
                {
                    input: {
                        prompt: 'RAW PHOTO, (hero eye mask:5), (superhero:3), (laser eyes:8), (scifi),(good looking), (blue, purple, red neon background colors:0.8), (high detailed skin:1.2), (highly detailed mask:3), (8k uhd, dslr, high quality, cinematic lighting, film grain, Fujifilm XT3:2)',
